...
public:
  ...
  virtual void enterDict(jsonParser::DictContext * /*ctx*/) override { }
  virtual void exitDict(jsonParser::DictContext * /*ctx*/) override { }

  virtual void enterList(jsonParser::ListContext * /*ctx*/) override { }
  virtual void exitList(jsonParser::ListContext * /*ctx*/) override { }
