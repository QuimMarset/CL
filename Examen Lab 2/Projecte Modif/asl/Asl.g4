...
array   
        : ARRAY '[' INTVAL ']' OF basicType //canviar per type per multidimensional (igual en SymbolListener)
        ;
...
statement
        ...
        | REPEAT statements UNTIL expr ENDREPEAT                # repeatStmt
        | functionCall  ';'                                     # functionCallStmt
        | READ left_expr ';'                                    # readStmt
        | WRITE expr ';'                                        # writeExpr
        | WRITE STRING ';'                                      # writeString
        | returnInst                                            # returnStmt
        | '[' multi_id ']' ASSIGN '[' multi_expr ']' ';'        # multiAssignStmt
        | SWITCH '(' expr ')' (caseVal)+ (defaultCase)? ENDSWITCH    # switchStmt
        | SWITCH '(' expr ')' (caseVal)* defaultCase ENDSWITCH       # switchStmt
        ;
