...
public:
  ...
  enum {
    ...
    RuleElseCond = 12, RuleMulti_id = 13, RuleMulti_expr = 14, RuleCaseVal = 15, 
    RuleDefaultCase = 16, RuleExpr = 17, RuleValue = 18, RuleLeft_expr = 19, 
    RuleIdent_refer = 20, RuleIdent = 21
  };
  ...
  class Multi_idContext;
  class Multi_exprContext;
  class CaseValContext;
  ...
  class  ReturnInstContext : public antlr4::ParserRuleContext {
  public:
    ReturnInstContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  public:
    ...
    std::vector<CaseValContext *> caseVal();
    CaseValContext* caseVal(size_t i);
  ...
  class  RepeatStmtContext : public StatementContext {
  public:
    RepeatStmtContext(StatementContext *ctx);

    antlr4::tree::TerminalNode *REPEAT();
    StatementsContext *statements();
    antlr4::tree::TerminalNode *UNTIL();
    ExprContext *expr();
    antlr4::tree::TerminalNode *ENDREPEAT();
    virtual void enterRule(antlr4::tree::ParseTreeListener *listener) override;
    virtual void exitRule(antlr4::tree::ParseTreeListener *listener) override;
  };

  class  MultiAssignStmtContext : public StatementContext {
  public:
    MultiAssignStmtContext(StatementContext *ctx);

    Multi_idContext *multi_id();
    antlr4::tree::TerminalNode *ASSIGN();
    Multi_exprContext *multi_expr();
    virtual void enterRule(antlr4::tree::ParseTreeListener *listener) override;
    virtual void exitRule(antlr4::tree::ParseTreeListener *listener) override;
  };
  ...
  class  Multi_idContext : public antlr4::ParserRuleContext {
  public:
    Multi_idContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  Multi_exprContext : public antlr4::ParserRuleContext {
  public:
    Multi_exprContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<ExprContext *> expr();
    ExprContext* expr(size_t i);
  ...
  class  CaseValContext : public antlr4::ParserRuleContext {
  public:
    CaseValContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  public:
    ...
    Ident_referContext *ident_refer();
    virtual void enterRule(antlr4::tree::ParseTreeListener *listener) override;
    virtual void exitRule(antlr4::tree::ParseTreeListener *listener) override;
  };
  ...
  class  Ident_referContext : public antlr4::ParserRuleContext {
  public:
    Ident_referContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    IdentContext *ident();
    std::vector<ExprContext *> expr();
    ExprContext* expr(size_t i);
